...
var dotenv = require("dotenv"); // Dependencia para manejar las variables de entorno cómodamente.
...
var _a = process.env, MYSQL_HOST = _a.MYSQL_HOST, MYSQL_USER = _a.MYSQL_USER, MYSQL_PASS = _a.MYSQL_PASS, MYSQL_DDBB = _a.MYSQL_DDBB;
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, pool.getConnection()]; //Devuelve la conexión.
            }
            catch (err) {
                console.error(err);
            }
